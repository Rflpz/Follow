...
- (void)customizeNavigationControllerOfController:(UIViewController *)controller{
    controller.navigationController.navigationBar.barTintColor = [[RLManager sharedInstance] colorFromHexString:@"#FFFFFF"];
    controller.navigationController.navigationBar.translucent = NO;
    controller.navigationController.navigationBar.titleTextAttributes = [NSDictionary dictionaryWithObjectsAndKeys:[[RLManager sharedInstance]  colorFromHexString:@"#6365f8"], NSForegroundColorAttributeName, [UIFont fontWithName:@"Avenir-Medium" size:16], NSFontAttributeName, nil];
}
@end
